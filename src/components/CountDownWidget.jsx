      ...
      <div className={styles.right}>
          <div className={styles.configurator}>
            <div className={styles.column}>
              ...
              <GoTriangleUp className={styles.label} onClick={()=>{handleIncrement('hour')}}/>
              <h3>{fixedHours.toString().padStart(2,'0')}</h3>
              <GoTriangleDown className={styles.label} onClick={()=>{handleDecrement('hour')}}/>
            </div>
            <div className={styles.column}>
              <p className={styles.label}>Minutes</p>
              <GoTriangleUp className={styles.label} onClick={()=>{handleIncrement('minute')}}/>
              <h3>{fixedMinutes.toString().padStart(2,'0')}</h3>
              <GoTriangleDown className={styles.label} onClick={()=>{handleDecrement('minute')}}/>
            </div>
            <div className={styles.column}>
              <p className={styles.label}>Seconds</p>
              <GoTriangleUp className={styles.label} onClick={()=>{handleIncrement('second')}}/>
              <h3>{fixedSeconds.toString().padStart(2,'0')}</h3>
              <GoTriangleDown className={styles.label} onClick={()=>{handleDecrement('second')}}/>
            </div>
          </div>
          {isActive ? (<>
                ...
                <button className={styles.start} onClick={handleStartStop}>Start</button>
          </>)}
      </div>
    </div>
  )
